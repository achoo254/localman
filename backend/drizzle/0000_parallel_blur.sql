...
CREATE UNIQUE INDEX "user_files_user_filename_idx" ON "user_files" USING btree ("user_id","filename");--> statement-breakpoint
CREATE INDEX "user_files_user_id_idx" ON "user_files" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "user_files_user_entity_idx" ON "user_files" USING btree ("user_id","entity_type");